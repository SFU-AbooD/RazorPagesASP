...
app.Run();
// this tells us why if we want to use await we need to put it in async function to tell compiler that we will need to make callbacks for some part of the body just to free the thread!!
